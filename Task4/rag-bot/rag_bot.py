...
Используй ТОЛЬКО информацию из приведённого контекста.
Если в документах нет нужной информации, скажи «Не знаю».  
...
class SimpleRAG:
    ...
    def build_prompt(self, query, search_results, use_cot=True):
        ...
        if use_cot:
            cot = """Объясни ход рассуждений, но НЕ цитируй запрещённые фразы. """
        else:
            cot = ""
...
Q: У кого были драконы?
A: Драконы были у клана Лейскавен. Лейскавены со времен основания рода были известны как наездники драконов.  
"""
...
Если информации недостаточно для ответа, скажи "Не знаю".
